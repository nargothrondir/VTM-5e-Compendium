...
# Силы из Руководства для игроков, ещё не перенесённые в компендиум.
# Список снят с книги один раз и хранится здесь, чтобы план перевода
# собирался без обращения к самим книгам.
