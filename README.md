...
**397 записей и 117 папок** — весь компендиум целиком.
...
- **Страницы истории** — все двадцать четыре из Книги правил: Тео Белл,
  Каинитская ересь, Голконда, Первая инквизиция, Высшие и Низшие кланы
  и далее. У каждой вступление и пять ступеней со своими названиями.
