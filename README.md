...
- **Кланы** — все шестнадцать: описание, список Дисциплин и Проклятие. Для семи
  кланов добавлено **альтернативное проклятие**. Бану Хаким, Геката, Ласомбра и
...
Принятые решения по терминологии — какое слово выбрано и почему —
собраны в отдельном документе: [Словарь терминов](GLOSSARY.md).
...
(четыре клана и альтернативные проклятья).
