...
**470 записей и 141 папка** — весь компендиум целиком.

| Компендиум | Записей |
|---|---:|
| Кланы | 16 |
| Дисциплины | 191 |
| Сила крови и тип охотника | 23 |
| Преимущества и недостатки | 143 |
| Страницы истории | 32 |
| Котерии | 65 |
...
- **Дисциплины** — 121 сила десяти Дисциплин, 35 ритуалов Кровавого
  чародейства и 7 формул Алхимии слабокровных, а также целиком **Обливион**:
  18 сил и 10 церемоний. У каждой записи указаны Амальгама, Расплата, Пул,
  Правила и Длительность.
- **Сила крови и тип охотника** — 7 уровней Силы Крови (от слабой крови до
  шестого и выше) и 16 типов охотника.
- **Преимущества и недостатки** — достоинства, недостатки и фоны, включая
  58 записей из Руководства для игроков: новые достоинства и недостатки, свои
  перечни у каитиффов, слабокровных и гулей, а также восемь фонов. Фоны
  собраны целиком, со всеми пятью ступенями в одной записи.
- **Страницы истории** — все двадцать пять из Книги правил (Тео Белл,
  Каинитская ересь, Голконда, Первая инквизиция, Высшие и Низшие кланы)
  и семь линий крови Гекаты из Руководства. У каждой вступление и пять
  ступеней со своими названиями.
- **Котерии** — 22 вида котерии (15 из Книги правил, 7 из Руководства),
  её достоинства и недостатки, 18 владений домена (шассе, льен, портильон)
  и 15 клановых достоинств членства — по одному на клан.
...
| `npm run regroup` | делит достоинства и недостатки по папкам |
| `npm run build` | собирает `_source` в базу, которую читает Foundry |
| `npm run verify` | проверяет целостность и показывает прогресс |
| `npm run audit` | ищет тихие огрехи: счёт по канону, выбросы, разметку |
| `npm run test` | проверяет саму проверку на известных огрехах |
